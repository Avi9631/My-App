<%@page import="com.example.model.SearchViewNotes"%>
        ...
        <div class="row">
            <div class="col-md-2 n1">
                ...
                <% String sub= request.getParameter("sub");
                	...
                	if(i.getNoteCategory().equals(sub)){%>
            ...
            <div class="col-md-8  n2">
                <div class="inp">
                <form action="SearchViewNotes" method="get">
                    <input type="text" placeholder="Search" name="searchName">
                    <input type="text" value="<%=sub %>" name="sub" style="display:none;">
                ...
                <h2>Notebook</h2>
                	...
                	<%if(!SearchViewNotes.viewNoteName.equals("") && !SearchViewNotes.viewNoteName.equalsIgnoreCase("ALL")){
                	 for(NotesModel i: UserModel.noteList){
                	if(i.getNoteCategory().equalsIgnoreCase(sub) &&
                			i.getNoteName().equalsIgnoreCase(SearchViewNotes.viewNoteName)){%>
                <div id="itemCon">
                    <a href="#"><%=i.getNoteName() %></a>
                    ...
                    <br>
					<a href="DeleteNoteBook?type=viewnotes&id=<%=i.getNoteId() %>">
                ...
                <div id="itemCon">
					...
					<a href="DeleteNoteBook?type=viewnotes&id=<%=i.getNoteId() %>">
                    	<span class="glyphicon glyphicon-erase" id="delete">Delete</span>
                    </a>                    <a><span class="glyphicon glyphicon-edit" id="edit">Edit&nbsp;</span></a>
                    <a onclick="document.getElementById('id03').style.display='block'"><span class="glyphicon glyphicon-plus" id="add"></span></a><br>
                    <p>Complete the assignment.</p>
                </div>
                <%}}} %>
